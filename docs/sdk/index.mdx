...
4. **Automatic token refresh** - SDK can automatically refresh expired tokens using the `refresh_token`. Tokens stop working, refresh included, once their user is deleted
