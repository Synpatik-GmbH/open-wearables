...
<Warning>
Scripts write directly to the database (the Svix user-channel migration writes to Svix instead). There is no automatic rollback. Take a database snapshot before running against production.
</Warning>
