...
<Steps>
  ...
  <Step title="Configure API Tools (endpoints + data types/scopes)">
    ...
    **Every endpoint in the list above also carries data concerning health.** Sleep, HRV, stress, respiration, blood pressure and the rest are special categories of personal data under **Art. 9 GDPR**. Processing any of them needs your deployment's own lawful basis and compliance assessment — this list does not establish one, and enabling only these endpoints does not make a deployment compliant.
