...
<Steps>
  ...
  <Step title="Configure API Tools (endpoints + data types/scopes)">
    ...
    **Which endpoints to enable:**
    ...
    This is the accept set Open Wearables declares in `supported_event_types()` at `backend/app/services/providers/garmin/webhook_handler.py:334`, minus `mct`. Anything Garmin pushes outside this set is not processed.
